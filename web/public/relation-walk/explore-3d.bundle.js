...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Mn,depthTest:!1,depthWrite:!1})}function fc(){return new Ke({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Xa(),fragmentShader:`
		...
		`,blending:Mn,depthTest:!1,depthWrite:!1})}function pc(){return new Ke({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Xa(),fragmentShader:`
...
#define LOW_PRECISION`),t}function um(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Fc?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===Pl?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===rn&&(t="SHADOWMAP_TYPE_VSM"),t}function dm(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case bi:case Ei:t="ENVMAP_TYPE_CUBE";break;case ar:t="ENVMAP_TYPE_CUBE_UV";break}return t}function fm(i){let t="ENVMAP_MODE_REFLECTION";return i.envMap&&i.envMapMode===Ei&&(t="ENVMAP_MODE_REFRACTION"),t}function pm(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Bc:t="ENVMAP_BLENDING_MULTIPLY";break;case th:t="ENVMAP_BLENDING_MIX";break;case eh:t="ENVMAP_BLENDING_ADD";break}return t}function mm(i){let t=i.envMapCubeUVHeight;if(t===null)return null;let e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function gm(i,t,e,n){let s=i.getContext(),r=e.defines,o=e.vertexShader,a=e.fragmentShader,c=um(e),l=dm(e),h=fm(e),f=pm(e),u=mm(e),m=e.isWebGL2?"":nm(e),g=im(e),x=sm(r),p=s.createProgram(),d,E,y=e.glslVersion?"#version "+e.glslVersion+`
...
`].filter(yi).join(`
`)),o=va(o),o=bc(o,e),o=Ec(o,e),a=va(a),a=bc(a,e),a=Ec(a,e),o=wc(o),a=wc(a),e.isWebGL2&&e.isRawShaderMaterial!==!0&&(y=`#version 300 es
...
`)+`
`+E);let A=y+d+o,I=y+E+a,C=Mc(s,s.VERTEX_SHADER,A),T=Mc(s,s.FRAGMENT_SHADER,I);s.attachShader(p,C),s.attachShader(p,T),e.index0AttributeName!==void 0?s.bindAttribLocation(p,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(p,0,"position"),s.linkProgram(p);function z(it){if(i.debug.checkShaderErrors){let Q=s.getProgramInfoLog(p).trim(),P=s.getShaderInfoLog(C).trim(),Y=s.getShaderInfoLog(T).trim(),V=!0,Z=!0;if(s.getProgramParameter(p,s.LINK_STATUS)===!1)if(V=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,p,C,T);else{let W=Sc(s,C,"vertex"),X=Sc(s,T,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(p,s.VALIDATE_STATUS)+`
